<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="showNotice = true">
    ...
    <div class="shop-header-discounts" @click="showDiscounts = true" v-if="info.supports">
    ...
    <transition name="fade">
      <div class="shop-brief-modal" v-show="showNotice"  >
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="showNotice = false">
